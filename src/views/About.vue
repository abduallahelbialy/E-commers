<template>
  <div class="about">
    <div class="container">
      <div class="row">
        <div
          class="who d-flex justify-content-center flex-column align-items-center"
        >
          <div class="img-who">
